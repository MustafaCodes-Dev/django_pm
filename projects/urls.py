...
urlpatterns = [
    ...
    path("task/create/<int:project_id>/", views.TaskCreateView.as_view(), name="Task_create"),    path('project/task/edit/<int:pk>',views.TaskUpdateView.as_view(), name= 'Task_update'),
